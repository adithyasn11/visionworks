...
// Only ever rendered for signed-out visitors — app/page.jsx redirects everyone
// else to their role's home before this runs.
//
// NOTE: this page previously withheld all markup until a `mounted` flag flipped
// after hydration, to dodge a theme mismatch. That is already handled properly
// in layout.jsx — the inline themeInit script applies the theme class before
// first paint, and <html suppressHydrationWarning> covers the diff. The gate was
// therefore shipping an empty 7KB document to every visitor and every crawler.
